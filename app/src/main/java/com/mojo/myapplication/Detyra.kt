...
class Detyra : AppCompatActivity() {
    lateinit var emri: EditText
    lateinit var mbiemri: EditText
    lateinit var kafsha: EditText
    lateinit var mosha: EditText
    ...
    var randomUserNames = listOf(
        randomUsername1(
            emri.text.toString(),
            mbiemri.text.toString(),
            kafsha.text.toString(),
            mosha.text
        ), randomUsername2(
            emri.text.toString(),
            mbiemri.text.toString(),
